...
public class SdpEncoderImpl {
	 ...
	 * information data. By default, the ISO-10646 character set in UTF-8 encoding
	 * is used. If a more compact representation is required, other character sets
	 * may be used such as ISO-8859-1 for Northern European languages.
	 * 
	 ...
	 *
	 * To make announcements more compact, times may also be given in units of days,
	 * hours or minutes. The syntax for these is a number immediately followed by a
	 * single case-sensitive character. Fractional units are not allowed - a smaller
	 * unit should be used instead. The following unit specification characters are
	 * allowed:
	 *
	 * d - days (86400 seconds) h - minutes (3600 seconds) m - minutes (60 seconds)
	 * s - seconds (allowed for completeness but not recommended)
	 *
	 * @param flag if true this Outputter should emit "typed" time specs in
	 *             preference to untyped times.
	 */
	...
	/**
	 * Specifies whether to generate "a=rtpmap:" attributes for static RTP/AVP
	 * format strings. This is recommended but makes messages bigger. The default is
	 * not to write such attributes.
	 * 
	 * @param flag if true "a=rtpmap:" attributes are generated for all "RTP/AVP"
	 *             formats
	 */
