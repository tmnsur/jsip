...
public class SessionDescriptionImpl implements SessionDescription {
	 ...
	 * @throws SdpException - if there is a problem constructing the
	 *                      SessionDescription.
	 */
		...
		if(otherAttributes != null) {
			...
			while(itAttributes.hasNext()) {
				...
				if (otherAttributeField != null) {
					// Attribute field clone() makes a deep copy but be careful: it may use
					// reflection to copy one of its members
				...
				if (otherMediaDescription != null) {
					...
					if (otherAFs != null) {
						...
						while (itAFs.hasNext()) {
							...
							if (otherAF != null) {
								// AttributeField clone() already makes a deep copy, but be careful. It will use
								// reflection
	...
	/**
	 * Returns the version of SDP in use. This corresponds to the v= field of the
	 * SDP data.
	 *
	...
	/**
	 * Sets the version of SDP in use. This corresponds to the v= field of the SDP
	 * data.
	 *
	...
	/**
	 * Returns information about the originator of the session. This corresponds to
	...
	/**
	 * Sets information about the originator of the session. This corresponds to the
	 * o= field of the SDP data.
	 *
	...
	/**
	 * Returns the name of the session. This corresponds to the s= field of the SDP
	 * data.
	 *
	 ...
	 * information of the session. This corresponds to the t= field of the SDP data.
	 *
	 * @param create boolean to set
	 * @throws SdpException
	 ...
	 *                        adjustments, where the key is the Adjusted Time Zone
	 ...
	 *
	 * @param create create - specifies whether to return null or a new empty Vector
	 *               in case no attributes exists for this Description
	...
	/**
	 * Adds a MediaDescription to the session description. These correspond to the
	 * m= fields of the SDP data.
	 *
	 * @param create boolean to set
	 * @throws SdpException
	...
	private String encodeVector(Vector<String> vector) {
	 ...
	 * Acknowledgement - this code was contributed by Emil Ivov.
	 *
