...
public class MediaDescriptionImpl implements MediaDescription {
	...
	protected Vector<SDPField> bandwidthFields;
	protected KeyField keyField;
	protected Vector<SDPField> attributeFields;
	...
	public String encode() {
		...
		if (bandwidthFields != null) {
			for(int i = 0; i < bandwidthFields.size(); i++) {
				retval.append(bandwidthFields.elementAt(i).encode());
			}
		...
		if (attributeFields != null) {
			for (int i = 0; i < attributeFields.size(); i++)
				retval.append(attributeFields.elementAt(i).encode());
		}
	...
	public Vector<SDPField> getAttributeFields() {
	 ...
	 */
	public void setAttributeFields(Vector<SDPField> a) {
		attributeFields = a;
	}
