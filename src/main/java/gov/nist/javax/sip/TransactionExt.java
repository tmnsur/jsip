...
public interface TransactionExt extends Transaction {
	...
	/**
	 * Returns the port of the upstream/downstream hop from which this message was
	 * initially received
	 * 
	 * @return the port of the upstream/downstream hop from which this message was
	 *         initially received
	 * @since 2.0
	 */
	 ...
	 * 
	 * @return Returns the cipher suite in use by the session which was produced by
	 *         the handshake.
	...
	/**
	 * @return the identity of the peer which was identified as part of defining the
	 *         session.
	 ...
	 * will include the reference to the Request, Response, Dialogs, Any unused
	 * timers etc. This will significantly reduce memory consumption under high load
	 * 
