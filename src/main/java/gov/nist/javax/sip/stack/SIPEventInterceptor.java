...
/**
 * This interface is the solution for
...
public interface SIPEventInterceptor {
	 ...
	 * before it is processed in the JAIN SIP pipeline.
	 * 
	 * @param message
	 */
	...
	/**
	 * This method is called when the interceptor is initialized. You can perform
	...
	/**
	 * This method is called when the interceptor is about to be destroyed. You can
