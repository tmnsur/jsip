...
public interface SIPServerTransaction
		extends SIPTransaction, ServerTransaction, ServerTransactionExt, ServerRequestInterface {
	...
	/**
	 * Process a new request message through this transaction. If necessary, this
	...
	/**
	 * Send a response message through this transaction and onto the client. The
	...
	/**
	 * Return the current transaction state according to the RFC 3261 transaction
	 * state machine. Invite transactions do not have a trying state. We just use
	 * this as a pseudo state for processing requests.
	 *
