...
public class ResponseEventExt extends ResponseEvent {
	...
	private ClientTransactionExt originalTransaction;
	...
	public ResponseEventExt(Object source, ClientTransactionExt clientTransaction, Dialog dialog, Response response) {
		...
		originalTransaction = clientTransaction;
	}
	 ...
	 * 
	 * @param originalTransaction - the original transaction for which this response
	 *                            event is a fork.
	 */
	...
	/**
	 * Get the original transaction for which this is a forked response. Note that
	 * this transaction can be in a TERMINATED state.
	 * 
