...
/**
 * The stack calls the message log factory to create logging records. The
 * default implementation of this interface can be replaced using the
 * gov.nist.javax.sip.LOG_RECORD_FACTORY property. This override is provided to
 * allow applications to log auxiliary information (such as environment
...
public interface LogRecordFactory {
	 ...
	 * @param timeStamp    -- The time at which this message was seen by the stack
	 *                     or sent out by the stack.
