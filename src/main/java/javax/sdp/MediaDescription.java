...
/**
 * A MediaDescription identifies the set of medias that may be received on a
 * specific port or set of ports. It includes:
 *
 * a mediaType (e.g., audio, video, etc.) a port number (or set of ports) a
 * protocol to be used (e.g., RTP/AVP) a set of media formats which correspond
 * to Attributes associated with the media description.
 *
...
public interface MediaDescription extends Serializable, Cloneable {
	 ...
	 * and may be null for Media objects if the corresponding session connection is
	 * non-null.
	 * 
	 * @return connection
	 */
	 ...
	 * 
	 * @param conn to set
	 * @throws SdpException if the connection is null
	 */
	 ...
	 */
	public Vector<SDPField> getBandwidths(boolean create);
	 ...
	 */
	public void setBandwidths(Vector<SDPField> bandwidths) throws SdpException;
	...
	/**
	 * Sets encryption key information. This consists of a method and an encryption
	 * key included in-line.
	 * 
	 ...
	 * objects in the order they were parsed.
	 * 
	 * @param create specifies whether to return null or a new empty Vector in case
	 *               no attributes exists for this Description
	 * @return attributes for this Description
	 */
	public Vector<SDPField> getAttributes(boolean create);
	 ...
	 */
	public void setAttributes(Vector<SDPField> attributes) throws SdpException;
	 ...
	 *
	 * The MIME type is computed in the following fashion: The type is the mediaType
	 * from the media field. The subType is determined by the protocol.
	 *
	 * The result is computed as the string of the form:
	 *
	 * type + '/' + subType
	 *
	 * The subType portion is computed in the following fashion. RTP/AVP the subType
	 * is returned as the codec name. This will either be extracted from the rtpmap
	 * attribute or computed. other the protocol is returned as the subType.
	 *
	 * If the protocol is RTP/AVP and the rtpmap attribute for a codec is absent,
	 * then the codec name will be computed in the following fashion. String indexed
	 * in table SdpConstants.avpTypeNames if the value is an int greater than or
	 * equal to 0 and less than AVP_DEFINED_STATIC_MAX, and has been assigned a
	 * value. SdpConstant.RESERVED if the value is an int greater than or equal to 0
	 * and less than AVP_DEFINED_STATIC_MAX, and has not been assigned a value.
	 * SdpConstant.UNASSIGNED An int greater than or equal to AVP_DEFINED_STATIC_MAX
	 * and less than AVP_DYNAMIC_MIN - currently unassigned. SdpConstant.DYNAMIC Any
	 * int less than 0 or greater than or equal to AVP_DYNAMIC_MIN
	 * 
	 ...
	 *                      are unequal.
	 */
	public void addDynamicPayloads(Vector<String> payloadNames, Vector<String> payloadValues) throws SdpException;
	 ...
	 * @throws SdpException
	 */
	public void setPreconditionFields(Vector<String> segPrecondition) throws SdpException;
	 ...
	 */
	public Vector<String> getPreconditionFields();
