 ...
 * starts with the scheme <code>tel:</code>. This tells the local entity that
 * what follows is a URL that should be parsed as described in
 * <a href = "http://www.ietf.org/rfc/rfc2806.txt">RFC2806</a>. After that, the
 * URL contains the phone number of the remote entity.
 * <p>
 ...
 * <ul>
 * <li>ISDN Subaddress - Phone numbers can also contain subaddresses, which are
 * used to identify different remote entities under the same phone number.
 * <li>Post Dial - Phone numbers can also contain a post-dial sequence. This is
 * what is often used with voice mailboxes and other services that are
 * controlled by dialing numbers from your phone keypad while the call is in
 * progress.
...
public interface TelURL extends URI, Parameters {
	/**
	 * Returns <code>true</code> if this TelURL is global i.e. if the TelURI has a
	 * global phone user.
	 *
	 * @return <code>true</code> if this TelURL represents a global phone user, and
	 ...
	 *
	 * @param global - the boolean value indicating if the TelURL has a global phone
	 *               user.
	 */
	public void setGlobal(boolean global);

	/**
	 * Sets post dial of this TelURL. The post-dial sequence describes what and when
	...
	/**
	 * Returns the value of the <code>postDial</code> parameter, or null if it is
	 * not set.
	 *
	...
	/**
	 * Returns the value of the <code>phoneNumber</code> parameter. This method will
	 * not return the "+" associated with telephone numbers.
	 *
	...
	/**
	 * Returns the value of the <code>isdnSubAddress</code> parameter, or null if it
	 * is not set.
	 *
	...
	/**
	 * Returns the value of the <code>phoneContext</code> parameter, or null if it
	 * is not set.
	 *
