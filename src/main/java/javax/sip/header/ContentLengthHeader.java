 ...
 * used as transport, the header field MUST be used.
 * <p>
 * The size of the message-body does not include the CRLF separating header
 * fields and body. Any Content-Length greater than or equal to zero is a valid
 * value. If no body is present in a message, then the Content-Length header
 * field value MUST be set to zero.
 *
