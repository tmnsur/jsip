 ...
 * receipt of the response. It can be used with a 500 (Server Internal Error) or
 * 503 (Service Unavailable) response to indicate how long the service is
...
public interface RetryAfterHeader extends Header, Parameters {
	...
	/**
	 * Gets the duration value of the RetryAfterHeader. This duration value is
	 * relative time.
	 *
