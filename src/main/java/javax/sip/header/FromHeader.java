 ...
 * 
 * participant in the dialog. When a User Agent sends a request outside of a
 * dialog,
 * 
 ...
 * 
 * in the To header field. When a tag is generated by a User Agent for insertion
 * into
 * 
...
public interface FromHeader extends HeaderAddress, Parameters, Header {
	 ...
	 * request identifies the peer of the dialog. When a UA sends a request outside
	 * of a dialog, it contains a From tag only, providing "half" of the dialog
	 * Identifier.
	 * <p>
	 ...
	 * requests the application is responsible for Tag assigmennment, after dialog
	 * establishment the stack will take care of Tag assignment.
	 *
	...
	/**
	 * Compare this FromHeader for equality with another. This method overrides the
	 ...
	 * From header fields are equivalent if their URIs match, and their parameters
	 ...
	 *         representing the same FromHeader as this, <code>false</code>
	 *         otherwise.
	 * @since v1.2
	 */
