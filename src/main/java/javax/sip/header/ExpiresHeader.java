 ...
 * content) expires. The precise meaning of this is method dependent. The
 * expiration time in an INVITE does not affect the duration of the actual
 * session that may result from the invitation. Session description protocols
 * may offer the ability to express time limits on the session duration,
 * however. The value of this field is an integral number of seconds (in
...
public interface ExpiresHeader extends Header {
	/**
	 * Sets the relative expires value of the ExpiresHeader in units of seconds. The
	 * expires value MUST be between zero and (2**31)-1.
	 *
	...
	/**
	 * Gets the expires value of the ExpiresHeader. This expires value is relative
	 * time.
	 *
