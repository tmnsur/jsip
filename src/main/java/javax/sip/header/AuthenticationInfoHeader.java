...
/**
 * The Authentication-Info header field provides for mutual authentication with
 * HTTP Digest. A UAS MAY include this header field in a 2xx response to a
 * request that was successfully authenticated using digest based on the
...
public interface AuthenticationInfoHeader extends Parameters, Header {
	 ...
	 * <var>nextNonce</var> parameter value.
	 *
	...
	/**
	 * Sets the Qop value of the AuthenticationInfoHeader to the new <var>qop</var>
	 * parameter value.
	 *
	 ...
	 *
	 * @return the string representing the messageQop information, null if the value
	 *         is not set.
	 */
	 ...
	 * <var>nonceCount</var> parameter value.
	 *
	...
	/**
	 * Sets the Response of the AuthenticationInfoHeader to the new
	 * <var>response</var> parameter value.
	 *
