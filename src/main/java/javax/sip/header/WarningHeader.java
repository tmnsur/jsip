 ...
 * contain a three-digit warning code, agent name, and warning text.
 * <ul>
 * <li>Warning Text: The "warn-text" should be in a natural language that is
 * most likely to be intelligible to the human user receiving the response. This
 * decision can be based on any available knowledge, such as the location of the
 * user, the Accept-Language field in a request, or the Content-Language field
 * in a response.
 ...
 * should display as many of them as possible, in the order that they appear in
 * the Response. If it is not possible to display all of the warnings, the user
 * agent first displays warnings that appear early in the Response.
 * <p>
 ...
 * <li>A 606 (Not Acceptable) response means that the user wishes to
...
public interface WarningHeader extends Header {
	...
	/**
	 * Sets the code of the WarningHeader. The standard RFC3261 codes are defined as
...
// Constants
	...
	/**
	 * One or more network protocols contained in the session description are not
	 * available.
	 */
	public static final int INCOMPATIBLE_NETWORK_PROTOCOL = 300;

	/**
	 * One or more network address formats contained in the session description are
	 * not available.
	 */
	public static final int INCOMPATIBLE_NETWORK_ADDRESS_FORMATS = 301;

	/**
	 * One or more transport protocols described in the session description are not
	 * available.
	 */
	public static final int INCOMPATIBLE_TRANSPORT_PROTOCOL = 302;

	/**
	 * One or more bandwidth measurement units contained in the session description
	 * were not understood.
	 */
	public static final int INCOMPATIBLE_BANDWIDTH_UNITS = 303;

	/**
	 * One or more media types contained in the session description are not
	 * available.
	 */
	public static final int MEDIA_TYPE_NOT_AVAILABLE = 304;

	/**
	 * One or more media formats contained in the session description are not
	 * available.
	 */
	public static final int INCOMPATIBLE_MEDIA_FORMAT = 305;

	/**
	 * One or more of the media attributes in the session description are not
	 * supported.
	 */
