 ...
 * number of the provisional response that is being acknowledged (each
 ...
 * from the CSeqHeader along with the method tag, from the response that is
 * being acknowledged.
 * <p>
 * For Example:<br>
...
public interface RAckHeader extends Header {
	...
	/**
	 * Sets the sequence number value of the CSeqHeader of the provisional response
	 * being acknowledged. The sequence number MUST be expressible as a 32-bit
