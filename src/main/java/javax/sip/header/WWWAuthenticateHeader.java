 ...
 * scheme(s) and parameters applicable to the realm.
 * <p>
 * For Example:<br>
...
public interface WWWAuthenticateHeader extends Parameters, Header {
	 ...
	 * Realm strings MUST be globally unique. It is RECOMMENDED that a realm string
	 * contain a hostname or domain name. Realm strings SHOULD present a
	...
	/**
	 * Returns the Realm value of this WWWAuthenicateHeader. This convenience method
	 * returns only the realm of the complete Challenge.
	 *
	...
	/**
	 * Sets the Algorithm of the WWWAuthenicateHeader to the new algorithm parameter
	 * value.
	 *
	...
	/**
	 * Sets the Qop value of the WWWAuthenicateHeader to the new qop parameter
	 * value.
	 *
	...
	/**
	 * Sets the Opaque value of the WWWAuthenicateHeader to the new opaque parameter
	 * value.
	 *
	 ...
	 *
	 * @return the String representing the Domain information, null if value is not
	 *         set.
	 */
