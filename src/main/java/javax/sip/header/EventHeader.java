 ...
 * when performing a comparison, i.e. "Event: foo; id=1234" would match "Event:
 * foo; param=abcd; id=1234", but not "Event: Foo; id=1234".
 * <p>
 ...
 * the event or event class. The "Event" header MAY also contain an "id"
 * parameter. When a subscription is created in the notifier, it stores the
 * event package name and the "Event" header "id" parameter (if present) as part
...
public interface EventHeader extends Parameters, Header {
	 ...
	 *
	 * @param eventType - the new string defining the eventType supported in this
	 *                  EventHeader
	 ...
	 *
	 * @return the string object identifying the eventType of EventHeader.
	 */
	...
	/**
	 * Gets the id of the EventHeader. This method may return null if the eventId is
	 * not set.
	 *
	 * @return the string object identifying the eventId of EventHeader.
	 */
