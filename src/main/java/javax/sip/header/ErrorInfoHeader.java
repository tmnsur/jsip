 ...
 * error indicator to render to the caller.
 * <p>
 * A UAC MAY treat a SIP or SIPS URI in an Error-Info header field as if it were
 * a Contact in a redirect and generate a new INVITE, resulting in a recorded
 * announcement session being established. A non-SIP URI MAY be rendered to the
 * user.
 * <p>
 * Examples:<br>
...
public interface ErrorInfoHeader extends Parameters, Header {
	...
	/**
	 * Returns the ErrorInfo value of this ErrorInfoHeader. This message may return
	 * null if a String message identifies the ErrorInfo.
	 *
