 ...
 * if it specified a Priority of <var>"Normal"</var>.
 * <p>
 * The Priority header field does not influence the use of communications
 * resources such as packet forwarding priority in routers or access to circuits
 * in PSTN gateways.
 * <p>
...
public interface PriorityHeader extends Header {
	...
	/**
	 * Emergency priority constant - It is RECOMMENDED that the value of "emergency"
	 * only be used when life, limb, or property are in imminent danger. Otherwise,
	 * there are no semantics defined for this header field.
	 * 
	 */
