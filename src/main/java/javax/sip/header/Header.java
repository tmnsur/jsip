 ...
 * by this specification. Extension Headers can be supported by this
 * specification as required by extending the {@link ExtensionHeader} assuming
 * other endpoints understand the Header. This specification supports the
 * following headers not defined in
 * <a href = "http://www.ietf.org/rfc/rfc3261.txt">RFC3261</a> documented in the
 * following standards track RFCs:
 * <ul>
 * <li>RAckHeader - this header is specific to the reliability of provisional
 * Responses. This functionality is defined in
 ...
 * framework. This functionality is defined in
 * <a href = "http://www.ietf.org/rfc/rfc3265.txt">RFC3265</a>.
 * <li>EventHeader - this header is specific to the event notification
 * framework. This functionality is defined in
 * <a href = "http://www.ietf.org/rfc/rfc3265.txt">RFC3265</a>.
 * <li>SubscriptionStateHeader - this header is specific to the event
 * notification framework. This functionality is defined in
 * <a href = "http://www.ietf.org/rfc/rfc3265.txt">RFC3265</a>.
 ...
 * semantics. Some header fields only make sense in requests or responses. These
 * are called request header fields and response header fields, respectively. If
 * a header field appears in a message not matching its category (such as a
 ...
 * list. In this specification each Header object has a single value or
 * attribute pair. For example a Header whose grammer is of the form: <br>
 ...
 * translate them into the relevent Header objects defined in this
 * specification.
 * <p>
 ...
 * Multiple headers with the same name MAY be present in a message if and only
 * if the entire field-value for that header field can be defined as a
 ...
 * Proxy-Authorization header fields. Multiple header objects with these names
 * MAY be present in a message, but since their grammar does not follow the
 * general form listed above, they MUST NOT be combined into a single header
 * field row when sent over the network.
 * <p>
...
public interface Header extends Cloneable, Serializable {
	...
	/**
	 * Compare this SIP Header for equality with another. This method overrides the
	 * equals method in java.lang.Object. This method is over-ridden further for
	 * each required header (To, From, CSeq, Call-ID, Max-Forwards, and Via) which
	 * object equality is outlined as specified by
	 * <a href = "http://www.ietf.org/rfc/rfc3261.txt">RFC3261</a>. All optional
	 * headers are compared using object equality that is each field in the header
	 * is used for comparision. When comparing header fields, field names are always
	 ...
	 *         representing the same SIP Header as this, <code>false</code>
	 *         otherwise.
	 */
	 ...
	 * deep copy of the Header, so that when a message is cloned the Header can be
	 * modified without effecting the original Header in the message. This provides
	 * useful functionality for proxying Requests and Responses, for example:
	 * <ul>
	...
	/**
	 * Gets a integer hashcode representation of the Header. This method overrides
	 * the hashcode method in java.lang.Object.
	 *
