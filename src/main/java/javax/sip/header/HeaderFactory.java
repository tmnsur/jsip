...
public interface HeaderFactory {
	 ...
	 * @throws ParseException which signals that an error has been reached
	 *                        unexpectedly while parsing the content type or content
	 *                        subtype value.
	...
	/**
	 * Creates a new AcceptLanguageHeader based on the newly supplied language
	 * value.
	 *
	...
	/**
	 * Creates a new AuthenticationInfoHeader based on the newly supplied response
	 * value.
	 *
	 ...
	 * @throws InvalidArgumentException if supplied sequence number is less than
	 *                                  zero.
	 * @throws ParseException           which signals that an error has been reached
	 *                                  unexpectedly while parsing the method value.
	...
	/**
	 * Creates a new wildcard ContactHeader. This is used in Register requests to
	 * indicate to the server that it should remove all locations the at which the
	 * user is currently available. This implies that the following conditions are
	 * met:
	 * <ul>
	 ...
	 * @throws ParseException which signals that an error has been reached
	 *                        unexpectedly while parsing the contentDisposition
	 *                        value.
	...
	/**
	 * Creates a new ContentLengthHeader based on the newly supplied contentLength
	 * value.
	 *
	...
	/**
	 * Creates a new Header based on the newly supplied name and value values. This
	 * method can be used to create ExtensionHeaders.
	 *
	...
	/**
	 * Creates a new List of Headers based on a supplied comma seperated list of
	 * Header values for a single header name. This method can be used only for SIP
	 * headers whose grammar is of the form header = header-name HCOLON header-value
	 * *(COMMA header-value) that allows for combining header fields of the same
	 * name into a comma-separated list. Note that the Contact header field allows a
	 * comma-separated list unless the header field value is "*"
	 * 
	 * @param headers the new string comma seperated list of Header values.
	 * @throws ParseException which signals that an error has been reached
	 *                        unexpectedly while parsing the headers value or a List
	 *                        of that Header type is not allowed.
	...
	/**
	 * Creates a new MaxForwardsHeader based on the newly supplied maxForwards
	 * value.
	 *
	 * @param maxForwards the new integer value of the maxForwards.
	 * @throws InvalidArgumentException if supplied maxForwards is less than zero or
	 *                                  greater than 255.
	 ...
	 * @throws InvalidArgumentException if supplied majorVersion or minorVersion is
	 *                                  less than zero.
	...
	/**
	 * Creates a new OrganizationHeader based on the newly supplied organization
	 * value.
	 *
	...
	/**
	 * Creates a new ProxyAuthenticateHeader based on the newly supplied scheme
	 * value.
	 *
	 * @param scheme the new string value of the scheme.
	 * @throws ParseException which signals that an error has been reached
	...
	/**
	 * Creates a new ProxyAuthorizationHeader based on the newly supplied scheme
	 * value.
	 *
	 * @param scheme the new string value of the scheme.
	 * @throws ParseException which signals that an error has been reached
	...
	/**
	 * Creates a new RAckHeader based on the newly supplied rSeqNumber, cSeqNumber
	 * and method values.
	 *
	 * @param rSeqNumber the new integer value of the rSeqNumber.
	 * @param cSeqNumber the new integer value of the cSeqNumber.
	 * @param method     the new string value of the method.
	 * @throws InvalidArgumentException if supplied rSeqNumber or cSeqNumber is less
	 ...
	 * @throws InvalidArgumentException if supplied sequenceNumber is less than zero
	 *                                  or greater than than 2**31-1.
	 ...
	 * @throws ParseException           which signals that an error has been reached
	 *                                  unexpectedly while parsing the protocol or
	 *                                  text value.
	 ...
	 * @throws ParseException which signals that an error has been reached
	 *                        unexpectedly while parsing the List of optionTag
	 *                        value.
	 ...
	 * @throws ParseException which signals that an error has been reached
	 *                        unexpectedly while parsing the subscriptionState
	 *                        value.
	 ...
	 * @throws ParseException           which signals that an error has been reached
	 *                                  unexpectedly while parsing the host,
	 ...
	 */
	public ViaHeader createViaHeader(String host, int port, String transport, String branch)
			throws ParseException, InvalidArgumentException;
	...
	/**
	 * Creates a new WarningHeader based on the newly supplied agent, code and
	 * comment values.
	 *
	 ...
	 * @throws ParseException           which signals that an error has been reached
	 *                                  unexpectedly while parsing the agent or
	 *                                  comment values.
	 * @throws InvalidArgumentException if an invalid integer code is given for the
	 *                                  WarningHeader.
	 ...
	 * @throws ParseException when an error occurs during parsing of the etag
	 *                        parameter
	 */
