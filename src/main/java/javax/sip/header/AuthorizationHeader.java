 ...
 * UNAUTHORIZED Response - by including an AuthorizationHeader with the Request.
 * The AuthorizationHeader consists of credentials containing the authentication
 ...
 * combined into a single header line.
 * <p>
 * For Example:<br>
...
public interface AuthorizationHeader extends Parameters, Header {
	...
	/**
	 * Sets the scheme of the Response information for this AuthorizationHeader. For
	 * example, Digest.
	 *
	 * @param scheme - the new string value that identifies the response information
	 *               scheme.
	 */
	...
	/**
	 * Sets the Realm of the AuthorizationHeader to the <var>realm</var> parameter
	 * value. Realm strings MUST be globally unique. It is RECOMMENDED that a realm
	 * string contain a hostname or domain name. Realm strings SHOULD present a
	 * human-readable identifier that can be rendered to a user.
	 *
	...
	/**
	 * Returns the Realm value of this AuthorizationHeader. This convenience method
	 * returns only the realm of the complete Response.
	 *
	 * @return the String representing the Realm information, null if value is not
	 *         set.
	 */
	...
	/**
	 * Sets the Nonce of the AuthorizationHeader to the <var>nonce</var> parameter
	 * value.
	 *
	 ...
	 *
	 * @return the String representing the nonce information, null if value is not
	 *         set.
	 */
	public String getNonce();

	/**
	 * Sets the URI of the AuthorizationHeader to the <var>uri</var> parameter
	 * value.
	 *
	 ...
	 *
	 * @note The syntax allows also non-URI strings, though it is not commonly used
	 *       with SIP. To avoid parsing the string and treat it as opaque,
	...
	/**
	 * Sets the Algorithm of the AuthorizationHeader to the new <var>algorithm</var>
	 * parameter value.
	 *
	 ...
	 *
	 * @return the String representing the Algorithm information, null if the value
	 *         is not set.
	 */
	public String getAlgorithm();

	/**
	 * Sets the CNonce of the AuthorizationHeader to the <var>cNonce</var> parameter
	 * value.
	 *
	 ...
	 *
	 * @return the String representing the cNonce information, null if value is not
	 *         set.
	 */
	public String getCNonce();

	/**
	 * Sets the Opaque value of the AuthorizationHeader to the new <var>opaque</var>
	 * parameter value.
	 *
	 ...
	 *
	 * @return the String representing the Opaque information, null if the value is
	 *         not set.
	 */
	 ...
	 *
	 * @return the string representing the Qop information, null if the value is not
	 *         set.
	 */
